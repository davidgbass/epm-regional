...
> La musique là où les enfants se trouvent déjà.

**EPM Régional** est un projet d'expansion provinciale de l'**École préparatoire de musique de l'UQAM (EPM)**. Il vise à rendre la pratique musicale collective accessible aux enfants de toutes les régions du Québec — particulièrement en milieu rural et défavorisé — en arrimant trois pôles habituellement déconnectés : le milieu scolaire, les organismes culturels communautaires et la rigueur pédagogique de l'UQAM.

Ce dépôt rassemble la documentation du projet : présentation aux fondations, dossiers de financement, suivi des points de service et des partenaires.
...
## Le modèle : trois pôles, un arrimage

| Pôle | Apport |
|------|--------|
| **EPM–UQAM** | Coordination · logistique · inscriptions · pérennité institutionnelle |
| **Organismes communautaires** | Instruments · locaux · partitions · réseaux locaux |
| **Milieu scolaire** | Les élèves là où ils se trouvent déjà (services de garde, écoles) |

La **coordination** est la clé de voûte : une ressource dédiée et rémunérée fait le pont entre les trois pôles et tisse, au fil du démarchage, la toile des points de service. Sortir du modèle 100 % bénévole est la condition de la pérennité.
...
| Dossier | Contenu |
|---------|---------|
| [`01-presentation/`](01-presentation/) | Document de présentation général, one-pagers, éléments visuels |
| [`02-fondations/`](02-fondations/) | Dossiers de financement adaptés à chaque fondation |
| [`03-partenaires/`](03-partenaires/) | Fiches des organismes et institutions partenaires |
| [`04-points-de-service/`](04-points-de-service/) | Suivi par région (Val-des-Sources, Brome-Missisquoi, expansion) |
| [`05-ressources/`](05-ressources/) | Notes sources, bilans, ancrage en recherche pédagogique |
